 ...
 * @author paul
 */
class StringValidator extends \mageekguy\atoum\test
{
    public function testValidateValue()
    {
        ...
        $this
            ->if($validator = new \Ongoo\Component\Form\Validators\StringValidator(3, null))
        ...
        $this
            ->if($validator = new \Ongoo\Component\Form\Validators\StringValidator(3, 5))
            ->boolean($validator->validateValue($field, '123'))->isTrue()
            ...
            ;
        $this
            ->if($validator = new \Ongoo\Component\Form\Validators\StringValidator(3))
            ->boolean($validator->validateValue($field, '123'))->isTrue()
            //-
            ->exception(function() use($validator, &$field) {
                    $validator->validateValue($field, '12');
